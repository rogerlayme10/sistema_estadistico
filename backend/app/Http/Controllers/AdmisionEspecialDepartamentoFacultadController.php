...
class AdmisionEspecialDepartamentoFacultadController extends Controller
{
    public function getEspecialDepartamentoFacultad(Request $request, $year = null)
    {
        if ($year) {
            ...
            $result = DB::table('admisions')
                ...
                ->whereNotIn('admisions.id_examen', [1, 2])//menos los de psa y pre
