...
class AdmisionEspecialProcedenciaCarreraController extends Controller
{
    public function getEspecialProcedenciaCarrera(Request $request, $year = null)
    {
        ...
        $procedencias = DB::table('admisions as a')
            ...
            //->where('a.id_examen', 1)
            ->whereNotIn('a.id_examen', [1, 2]) // Filtrar registros con id_examen fuera de 1 y 2
            ->where('a.estado', 'A')
            ->groupBy('p.programa')
            ->get();
