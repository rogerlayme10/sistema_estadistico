...
class MovilidadTransferenciaFacultadController extends Controller
{
    public function getTransferenciaFacultad(Request $request, $gestion = null)
    {
        if ($gestion) {
            ...
            $resultados = DB::table('tramites')
                ...
                ->where(DB::raw("TRIM(tramite)"), 'TRANSFERENCIA') // Filtro adicional por tipo_beca = 'alimentación'
                ->groupBy('facultad')
