...
class MovilidadSuspensionFacultadController extends Controller
{
    public function getSuspensionFacultad(Request $request, $gestion = null)
    {
        if ($gestion) {
            ...
            $resultados = DB::table('tramites')
                ...
                ->where(DB::raw("TRIM(tramite)"), 'SUSPENSION') // Filtro adicional por tipo_beca = 'alimentación'
                ->groupBy('facultad')
