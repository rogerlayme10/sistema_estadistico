...
class AdmisionPsaFacultadController extends Controller
{
    public function getPsaFacultad(Request $request)
    {
        ...
        ->select(
            'facultads.facultad',
            DB::raw("COUNT(CASE WHEN admisions.id_examen= '1' THEN 1 END) as inscritos"),
            DB::raw("COUNT(CASE WHEN admisions.estado = 'A' AND admisions.id_examen = '1' THEN 1 END) as aceptados")
        )
