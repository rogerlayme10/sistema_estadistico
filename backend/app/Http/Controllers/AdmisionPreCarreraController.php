...
class AdmisionPreCarreraController extends Controller
{
    public function getPreCarrera(Request $request)
    {
        ...
        ->select(
            'programas.programa',
            DB::raw("SUM(CASE WHEN id_examen = '2' THEN 1 ELSE 0 END) as inscritos"),
            DB::raw("SUM(CASE WHEN estado = 'A' AND admisions.id_examen = '2' THEN 1 ELSE 0 END) as aceptados"),
