...
class MovilidadNotasFacultadController extends Controller
{
    public function getNotasFacultad(Request $request, $gestion = null)
    {
        if ($gestion) {
            ...
            $resultados = DB::table('tramites')
                ...
                ->where(DB::raw("TRIM(tramite)"), 'NOTAS') // Filtro adicional por tipo_beca = 'alimentación'
                ->groupBy('facultad')
