...
class BecaAlimentacionFacultadController extends Controller
{
    public function getAlimentacionFacultad(Request $request, $gestion = null)
    {
    if ($gestion) {
        ...
        $resultados = DB::table('becas')
            ...
            ->where( DB::raw("TRIM(tipo_beca)"),'ALIMENTACION') // Filtro adicional por tipo_beca = 'alimentación'
            ->groupBy('facultad')
