...
class AdmisionEspecialLugarCarreraController extends Controller
{
    public function getEspecialLugarCarrera(Request $request, $year = null)
    {
        ...
        $lugar = DB::table('admisions as a')
            ...
            ->whereNotIn('a.id_examen', [1, 2])//menbos los de psa y pre
            ->where('a.estado', 'A')
            ->groupBy('p.programa')
            ->get();
