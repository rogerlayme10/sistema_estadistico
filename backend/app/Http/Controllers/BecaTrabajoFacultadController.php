...
class BecaTrabajoFacultadController extends Controller
{
    public function getTrabajoFacultad(Request $request, $gestion = null)
    {
        if ($gestion) {
            ...
            $resultados = DB::table('becas')
                ...
                ->where(DB::raw("TRIM(tipo_beca)"), 'TRABAJO') // Filtro adicional por tipo_beca = 'alimentación'
                ->groupBy('facultad')
