...
class AdmisionEspecialCarreraController extends Controller
{
    public function getEspecialCarrera(Request $request)
    {
        ...
        ->select(
            'programas.programa',
            DB::raw("SUM(CASE WHEN id_examen NOT IN (1, 2) THEN 1 ELSE 0 END) as inscritos"),
            DB::raw("SUM(CASE WHEN estado = 'A' AND admisions.id_examen NOT IN (1, 2) THEN 1 ELSE 0 END) as aceptados"),
