...
class MovilidadReadmisionFacultadController extends Controller
{
    public function getReadmisionFacultad(Request $request, $gestion = null)
    {
        if ($gestion) {
            ...
            $resultados = DB::table('tramites')
                ...
                ->where(DB::raw("TRIM(tramite)"), 'READMISION') // Filtro adicional por tipo_beca = 'alimentación'
                ->groupBy('facultad')
