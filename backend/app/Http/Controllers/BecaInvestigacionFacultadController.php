...
class BecaInvestigacionFacultadController extends Controller
{
    public function getInvestigacionFacultad(Request $request, $gestion = null)
    {
        if ($gestion) {
            ...
            $resultados = DB::table('becas')
                ...
                ->where(DB::raw("TRIM(tipo_beca)"), 'AUXILIAR DE INVESTIGACION') // Filtro adicional por tipo_beca = 'alimentación'
                ->groupBy('facultad')
