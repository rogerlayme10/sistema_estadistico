...
const UnidadSexo = () => {
    ...
    const fetchData = async (year = null) => {
        const url = year ? `${config.API_URL}/administrativos-unidad/${year}` : `${config.API_URL}/administrativos-unidad`;
    ...
    const sortedData = [...data].sort((a, b) => a.unidad.localeCompare(b.unidad));
