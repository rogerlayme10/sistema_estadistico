...
const InvestigacionCarrera = () => {
    ...
    const fetchData = async (year = null) => {
        try {
            const url = year ? `${config.API_URL}/investigacion-carrera/${year}` : `${config.API_URL}/investigacion-carrera`;
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, `Beca_InvestigacionCarrera${gestion}.xlsx`);
    };
...
export default InvestigacionCarrera;