...
const DocenciaFacultad = () => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(wb, `Beca_DocenciaFacultad${gestion}.xlsx`);
  };
  ...
  const downloadChartImage = () => {
    ...
    saveAs(base64Image, `Beca_DocenciaFacultad${gestion}.png`); // Guardar imagen como archivo PNG
  };
  ...
  return (
    <Row>
      <Col xs={12} md={5} xl={5}>
        <Card>
          <CardHeader>
            Beca Auxiliar de Docencia por Sexo, según Facultad.
            <Form.Select
              className="mt-2"
              value={gestion}
