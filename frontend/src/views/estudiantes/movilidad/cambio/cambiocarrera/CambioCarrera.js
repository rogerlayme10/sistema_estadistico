...
const ActasCarrera = () => {
    ...
    const fetchData = async (year = null) => {
        try {
            const url = year ? `${config.API_URL}/cambio-carrera/${year}` : `${config.API_URL}/cambio-carrera`;
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, `Cambio_Carrera${gestion}.xlsx`);
    };
