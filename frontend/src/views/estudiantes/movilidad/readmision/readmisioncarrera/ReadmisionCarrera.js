...
const ReadmisionCarrera = () => {
    ...
    const fetchData = async (year = null) => {
        try {
            const url = year ? `${config.API_URL}/readmision-carrera/${year}` : `${config.API_URL}/readmision-carrera`;
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, `Readmision_Carrera${gestion}.xlsx`);
    };
...
export default ReadmisionCarrera;