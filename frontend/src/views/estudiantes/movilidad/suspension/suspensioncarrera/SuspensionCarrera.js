...
const SuspensionCarrera = () => {
    ...
    const fetchData = async (year = null) => {
        try {
            const url = year ? `${config.API_URL}/suspension-carrera/${year}` : `${config.API_URL}/suspension-carrera`;
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, `Suspension_Carrera${gestion}.xlsx`);
    };
...
export default SuspensionCarrera;