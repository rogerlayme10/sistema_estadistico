    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion estudiantil Matriculados por Procedencia Educativa, según Carrera.
...
export default PoblacionProcedenciaCarrera;
