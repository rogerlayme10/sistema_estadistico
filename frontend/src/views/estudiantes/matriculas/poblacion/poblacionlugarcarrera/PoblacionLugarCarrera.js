    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion Estudiantil Matriculados por Lugar de Nacimiento, según Carrera.
                    </CardHeader>
                    ...
                    <Table bordered>
                        <thead>
                            <tr>
                                ...
                                <th colSpan="5" className="text-center">Lugarde Nacimiento</th>
...
export default PoblacionLugarCarrera;
