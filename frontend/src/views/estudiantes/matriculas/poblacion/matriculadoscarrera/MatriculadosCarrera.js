...
const MatriculadosSexoFacultad = () => {
    ...
    const fetchData = async (gestion) => {
        try {
            const url = gestion
                ? `${config.API_URL}/matriculados-sexo-carrera?gestion=${gestion}`
                : `${config.API_URL}/matriculados-sexo-carrera`;
    ...
    return (
        <Row>
            <Col >
                <Card>
                    <CardHeader>
                        Población Estudiantil Matriculada por Sexo, según Carrera.
                        <Form.Select
