    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion estudiantil Matriculados por Lugar de Nacimiento, según Facultad.
                    </CardHeader>
...
export default PoblacionLugarFacultad;
