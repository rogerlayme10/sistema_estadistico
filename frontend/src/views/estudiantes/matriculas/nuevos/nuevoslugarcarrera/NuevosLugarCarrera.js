    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion Estudiantil Nuevos por Lugar de Nacimiento, según Carrera.
                    </CardHeader>
...
export default NuevosLugarCarrera;
