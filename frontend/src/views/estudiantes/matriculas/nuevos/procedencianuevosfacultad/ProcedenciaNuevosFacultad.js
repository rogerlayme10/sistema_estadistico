    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion Estudinatil Nuevos por Procedencia Educativa, según Facultad.
...
export default ProcedenciaNuevosFacultad;
