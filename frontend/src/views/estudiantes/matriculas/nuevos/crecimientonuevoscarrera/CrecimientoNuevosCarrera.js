...
const CrecimientoNuevosCarrera = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${config.API_URL}/tasa-crecimiento-carrera`);
    ...
    const lineChartData = {
        ...
        datasets: [
            {
                label: 'Total de Nuevos Estudiantes',
    ...
    const lineChartOptions = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Crecimiento de Estudiantes Nuevos por Gestión',
            },
        },
        scales: {
            y: {
                min: 3500,  // Valor mínimo del eje Y
                max: 5000,  // Valor máximo del eje Y
                ticks: {
                    stepSize: 100,  // Incremento de 100 en el eje Y
                },
            },
        },
    };
    ...
    const downloadExcel = () => {
        ...
        XLSX.writeFile(workbook, "tasa_crecimiento_estudiantes_nuevos.xlsx");
    };
    ...
    return (
        <Row>
            <Col xs={12} md={6} xl={6}>
                <Card>
                    <CardHeader>Tasa de Crecimiento Estudiantes Nuevos Matriculados por Sexo, Según Carrera.</CardHeader>
                    <Table bordered>
                        <thead>
                            <tr>
            ...
            <Col xs={12} md={6} xl={6}>
                <Card>
                    <CardHeader>Gráfico de Lineas: Distribución por Gestion</CardHeader>
                    {/* Gráfico de líneas */}
...
export default CrecimientoNuevosCarrera;
