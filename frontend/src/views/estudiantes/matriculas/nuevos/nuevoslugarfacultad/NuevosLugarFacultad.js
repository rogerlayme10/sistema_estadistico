    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion estudiantil Matriculados Nuevos por Lugar de Nacimiento, según Facultad.
                    </CardHeader>
                    ...
                    <Table bordered>
                        <thead>
                            <tr>
                                ...
                                <th colSpan="5" className="text-center">Lugar de Nacimiento</th>
...
export default NuevosLugarFacultad;
