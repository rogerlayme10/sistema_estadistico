...
const CrecimientoNuevosCarrera = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${config.API_URL}/crecimiento-regular-carrera`);
    ...
    const lineChartData = {
        ...
        datasets: [
            {
                label: 'Total de Regular Estudiantes',
    ...
    const lineChartOptions = {
        ...
        scales: {
            y: {
                min: 20000,  // Valor mínimo del eje Y
                max: 25000,  // Valor máximo del eje Y
                ticks: {
                    stepSize: 500,  // Incremento de 100 en el eje Y
                },
            },
        },
    };
    ...
    const downloadExcel = () => {
        ...
        XLSX.writeFile(workbook, "tasa_crecimiento_estudiantes.xlsx");
    };
    ...
    const downloadChartImage = () => {
        ...
        link.href = url;
        link.download = 'grafico_tasa_crecimiento.png';
        link.click();
    };
