    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Poblacion estudiantil Matriculados regulares por Lugar, según Facultad.
                    </CardHeader>
...
export default RegularLugarFacultad;
