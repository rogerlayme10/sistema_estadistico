...
const PreEdadSexo = () => {
    ...
    useEffect(() => {
        ...
        const fetchGestiones = async () => {
            try {
                const response = await fetch(`${config.API_URL}/pre-edadsexo`);
    ...
    useEffect(() => {
        ...
        const fetchDatos = async () => {
            ...
            try {
                const response = await fetch(`${config.API_URL}/pre-edadsexo?gestion=${gestion}`);
