    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Cursos PRE Universitarios por Lugar Nacimiento, según Carrera.
                    </CardHeader>
                    ...
                    <Table bordered>
                        <thead>
                            <tr>
                                ...
                                <th colSpan="5" className="text-center">Lugar Nacimiento</th>
...
export default PsaLugarCarrera;
