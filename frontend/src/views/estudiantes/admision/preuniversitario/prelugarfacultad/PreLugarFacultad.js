    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Cursos PRE Universitarios por Lugar de Nacimiento, según Facultad.
                    </CardHeader>
...
export default PreLugarFacultad;
