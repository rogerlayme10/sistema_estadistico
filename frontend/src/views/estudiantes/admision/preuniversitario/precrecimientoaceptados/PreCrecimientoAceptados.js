...
const PreCrecimientoAceptados = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${config.API_URL}/pre-tasa-crecimiento-aceptados`);
    ...
    return (
        <Row>
            <Col xs={12}>
                <Card>
                    <CardHeader>Cursos PRE Universitarios  Tasa de Crecimiento de Aceptados por Gestión, según Carrera</CardHeader>
                    <Table bordered>
                        <thead>
                            <tr>
                            ...
                            <tr>
                                ...
                                {Object.keys(tasas).map((periodo) => (
                                    <th key={periodo}>Tasa {periodo}</th>
                                ))}
                            </tr>
                        </thead>
                        <tbody>
...
export default PreCrecimientoAceptados;
