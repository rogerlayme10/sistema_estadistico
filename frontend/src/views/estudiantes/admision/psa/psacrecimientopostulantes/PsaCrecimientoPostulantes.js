...
const PsaCrecimientoPostulantes = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${config.API_URL}/psa-tasa-crecimiento-postulantes`);
    ...
    const lineChartOptions = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Crecimiento de postulantes PSA',
            },
        },
    ...
    return (
        <Row>
            <Col xs={12} md={6} xl={6}>
                <Card>
                    <CardHeader>Tasa de crecimiento postulantes de PSA según </CardHeader>
                    <Table bordered>
                        <thead>
                            <tr>
...
export default PsaCrecimientoPostulantes;
