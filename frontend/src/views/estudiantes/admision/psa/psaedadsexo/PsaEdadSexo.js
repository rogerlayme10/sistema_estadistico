...
const PsaEdadSexo = () => {
    ...
    useEffect(() => {
        ...
        const fetchGestiones = async () => {
            try {
                const response = await fetch(`${config.API_URL}/psa-edadsexo`);
    ...
    useEffect(() => {
        ...
        const fetchDatos = async () => {
            ...
            try {
                const response = await fetch(`${config.API_URL}/psa-edadsexo?gestion=${gestion}`);
