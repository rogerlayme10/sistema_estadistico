    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                    Admision Especial por Procedencia Educativa, según  Carrera.
...
export default EspecialProcedenciaCarrera;