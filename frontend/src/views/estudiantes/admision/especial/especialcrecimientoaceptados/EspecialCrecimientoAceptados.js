...
const EspecialCrecimientoAceptados = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`${config.API_URL}/especial-tasa-crecimiento-aceptados`);
    ...
    const lineChartData = {
        ...
        datasets: [
            {
                label: 'Total de Postulantes Admision Especial Aceptados',
    ...
    const lineChartOptions = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Crecimiento de postulantes PRE Aceptados',
            },
        },
    ...
    return (
        <Row>
            <Col xs={12} md={6} xl={6}>
                <Card>
                    <CardHeader>Tasa de crecimiento postulantes de Admision Especial Aceptados </CardHeader>
                    <Table bordered>
                        <thead>
                            <tr>
...
export default EspecialCrecimientoAceptados;
