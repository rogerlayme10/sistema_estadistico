    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Admision Especial por Lugar, según Carrera.
                    </CardHeader>
...
export default EspecialLugarCarrera;
