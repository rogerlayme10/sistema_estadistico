    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                        Admision Especial por Lugar, según Facultad.
                    </CardHeader>
...
export default EspecialLugarFacultad;
