    ...
    return (
        <Row>
            <Col>
                <Card>
                    <CardHeader>
                    Admision Especial por Procedencia Educativa, según  Facultad.
...
export default EspecialProcedencia;