...
const FacultadGraduados = () => {
    ...
    const fetchData = async (gestion_acta) => {
        try {
            const url = gestion_acta
                ? `${config.API_URL}/graduados-facultad?gestion_acta=${gestion_acta}`
                : `${config.API_URL}/graduados-facultad`;
    ...
    const downloadChartImage = () => {
        ...
        if (chart) {
            ...
            link.href = imageURL;
            link.download = `Grafico_Graduados_Facultad_${selectedGestion}.png`;
            link.click();
        }
    };
    ...
    return (
        <Row>
            <Col xs={12} md={6} xl={6}>
                <Card>
                    <CardHeader>
                        Graduados por Sexo, segun  Facultad.
                        <Form.Select
            ...
            <Col xs={12} md={6} xl={6}>
                <Card>
                    <CardHeader>Gráfica de Barras: Distribuciónpor Facultad</CardHeader>
